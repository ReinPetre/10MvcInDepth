...
namespace Beerhall.Tests.Models.Domain {
    public class BrewerTest {
        ...
        [Fact]
        public void NewBrewer_TurnoverNegative_ThrowsException() {
        ...
        [InlineData("abc@de")]
        [InlineData("ab.c@de.")]
        public void NewBrewer_EmailInvalid_ThrowsException(string contactEmail) {
            Assert.Throws<ArgumentException>(() => new Brewer("Rodenbach") { ContactEmail = contactEmail });
        }

        [Fact]
        public void NewBrewer_DateEstablishedFutureDate_ThrowsException() {
        ...
        #region Add
        [Fact]
        public void AddBeer_ValidBeer_AddsABeer() {
        ...
        [Fact]
        public void AddBeer_BeerWithADuplicateName_ThrowsException() {
